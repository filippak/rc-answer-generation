...
python create_CAR_dataset.py ../data_frames/parsed_answer_data/df_train_cleaned.pkl ../data_frames/relevant_sentences/cleaned_data/lemma_stop.pkl ./data/labeled_CAR_training_data.pkl
...
python create_CRA_dataset.py ../data_frames/parsed_answer_data/df_train_cleaned.pkl ../data_frames/relevant_sentences/cleaned_data/lemma_stop.pkl ./data/labeled_CRA_training_data.pkl