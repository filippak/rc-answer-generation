...
# RE-RUNNING THIS RE-CREATED THE TRAIN AND EVAL STATS!!! 

echo 'dividing train / eval data..'
...
echo 'setting context text ids of test data..'
# python divide_train_eval_dataset.py ../data_frames/parsed_answer_data/df_test.pkl ../data_frames/relevant_sentences/test_data/lemma_stop.pkl ./data/labeled_data --test
...
python create_CA_dataset.py ./data/labeled_data_test.pkl ./data/CA/labeled_CA_data_test.pkl
...
echo 'creating CR->A dataset for test data '
python create_CRA_dataset.py ./data/labeled_data_test.pkl ./data/CRA/labeled_CRA_data_test.pkl
...
echo 'creating CA->R sentence classification dataset for test data'
python create_CAR_sent_classification_dataset.py ./data/labeled_data_test.pkl ./data/CAR_classification/labeled_CAR_data_test.pkl