...
python parse_json_files.py ../../data/data_cleaned/training_clean.json ../../data/data_cleaned/qa_part3_clean.json ../data_frames/parsed_json_data/df_train_cleaned.pkl

# Parse the original data
echo 'parsing original data..'
python parse_json_files.py ../../data/training.json ../../data/dataset-2022-03-09/qa_part3.json ../data_frames/parsed_json_data/df_train_original.pkl

# Parse the test data
echo 'parsing test data..'
python parse_json_files.py ../../data/test.json null ../data_frames/parsed_json_data/df_test.pkl --single
...
echo 'calculating and exporting tf-idf scores'
python tf-idf_calculation.py ../data_frames/parsed_answer_data/df_train_cleaned.pkl ../data_frames/tf-idf/df_tf_idf

echo 'COLLECTING RELEVANT SENTENCES'

echo 'Finding relevant sentences for cleaned data..'
python relevant_sentences.py ../data_frames/parsed_answer_data/df_train_cleaned.pkl ../data_frames/dependency_parsed_data/df_train_cleaned.pkl ../data_frames/relevant_sentences/cleaned_data/

echo 'Finding relevant sentences for original data..'
python relevant_sentences.py ../data_frames/parsed_answer_data/df_train_original.pkl ../data_frames/dependency_parsed_data/df_train_original.pkl ../data_frames/relevant_sentences/original_data/

echo 'Finding relevant sentences for test data..'
python relevant_sentences.py ../data_frames/parsed_answer_data/df_test.pkl ../data_frames/dependency_parsed_data/df_test.pkl ../data_frames/relevant_sentences/test_data/