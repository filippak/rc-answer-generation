...
python eval_CAR_classification.py ../results/CAR_classification/model_CAR_CLASS_3e_INS15_subset.pkl ../data/CAR_classification/data_subset/CAR_class_data_eval.pkl INS15