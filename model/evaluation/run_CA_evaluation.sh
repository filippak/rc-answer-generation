...
python eval.py ../results/CA/model_CA_3e_INS ../data/CA/tokenized_CA_data_eval_with_id.pkl ./data/CA/tokenized_output_data_CA_INS.pkl INS --strict
...
python eval.py ../results/CA/model_CA_3e_ISNS ../data/CA/tokenized_CA_data_eval_with_id.pkl ./data/CA/tokenized_output_data_CA_ISNS.pkl ISNS --strict
...
python eval.py ../results/CA/model_CA_3e_INS15 ../data/CA/tokenized_CA_data_eval_with_id.pkl ./data/CA/tokenized_output_data_CA_INS15.pkl INS15 --strict
...
python eval.py ../results/CA/model_CA_3e_INS125 ../data/CA/tokenized_CA_data_eval_with_id.pkl ./data/CA/tokenized_output_data_CA_INS125.pkl INS125 --strict
...
python eval.py ../results/CA/model_CA_3e_INS1375 ../data/CA/tokenized_CA_data_eval_with_id.pkl ./data/CA/tokenized_output_data_CA_INS1375.pkl INS1375 --strict
...
echo 'STRICT evaluation of C -> A model, trained with INS^(1.25) weighted loss. '
python eval.py ../results/CA/model_CA_3e_INS1125 ../data/CA/tokenized_CA_data_eval_with_id.pkl ./data/CA/tokenized_output_data_CA_INS1125.pkl INS1125 --strict
