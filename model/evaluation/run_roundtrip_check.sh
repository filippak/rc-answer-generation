...
python extract_roundtrip_consistant_answers.py ./data/CA/fixed_seed/tokenized_output_data_CA_INS.pkl ./data/CRA/fixed_seed/tokenized_output_data_CRA_ISNS_strict.pkl 