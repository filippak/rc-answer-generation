...
echo 'RUNNING EVALUATION ON C, A -> R MODEL'
...
python eval.py ../results/model_CAR_3e_weighted_loss.pkl ../data/CAR/tokenized_CAR_data_eval_with_id.pkl ./data/CAR/tokenized_output_data_CAR_INS.pkl

echo 'STRICT evaluation of C, A -> R model, trained with INS weighted loss. '
# run evaluation of CAR data, trained on INS weights in loss function
python eval.py ../results/model_CAR_3e_weighted_loss.pkl ../data/CAR/tokenized_CAR_data_eval_with_id.pkl ./data/CAR/tokenized_output_data_CAR_INS_strict.pkl --strict
